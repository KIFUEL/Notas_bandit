...
## Solución
desensamblamos el programa  le programa en la funcion main
```
...
La pista nos dice que la bander empieza en 70. Por lo que el inicio está aquí 0x0000000000001184 <+27>: movb $0x70,-0x30(%rbp)


```
70 69 63 6f 43 54 46 7b 41 53 43 49 49 5f 49 53 5f, 45 41 53 59 5f 33 43 46 34 42 46 41 44 7d

decodificamos de hecadecimal con cyberchef 
